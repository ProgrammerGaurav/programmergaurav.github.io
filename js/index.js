...
const cursorDot = ({
  ...
  const tim = easing / 15
  dot.style = `position:absolute;top:0;left:0;border-radius:100%;pointer-events:none;opacity:0;z-index:1000000;height:${diameter}px;width:${diameter}px;background:${background};border:${borderWidth}px solid ${borderColor};mix-blend-mode:exclusion;transition:background ${tim}s,border ${tim}s;will-change:transform;`
